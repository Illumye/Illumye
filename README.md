...
| :--- | :--- | :--- |
| **[Net Puzzle Game](https://angy-seguy.emi.u-bordeaux.fr/net-a22-zt94km/)** | `C`, `SDL`, `Wasm` | Clone d'un puzzle game porté sur navigateur via WebAssembly et Emscripten. |
